...
namespace FFramework.Kit
{
    ...
    /// 高级拖拽工具，提供各种拖拽功能的封装
    /// </summary>
    public class DragKit : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        #region 配置选项
        ...
        /// </summary>
        public static DragKit Get(GameObject target)
        {
            var dragKit = target.GetComponent<DragKit>();
            if (dragKit == null)
            {
                dragKit = target.AddComponent<DragKit>();
            }
            return dragKit;
        }
        ...
        /// </summary>
        public static DragKit Get(Component target)
        {
        ...
        public DragKit SetDragConfig(bool enableDrag = true, bool returnToOriginal = false, float returnSpeed = 5f)
        {
        ...
        public DragKit SetVisualEffects(bool scaleOnDrag = false, Vector3 dragScale = default, bool fadeOnDrag = false, float dragAlpha = 0.7f)
        {
        ...
        public DragKit SetConstraints(bool constrainToParent = false, bool constrainToScreen = true, Vector2 dragBounds = default)
        {
        ...
        public DragKit SetCallbacks(Action<PointerEventData> onBeginDrag = null, Action<PointerEventData> onDrag = null, Action<PointerEventData> onEndDrag = null)
        {
