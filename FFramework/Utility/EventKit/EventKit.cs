...
{
    /// <summary>
    /// EventKit类，用于处理Unity UI事件相关的功能
    /// 提供所有Unity EventSystem接口的便捷绑定方式
    /// </summary>
    public class EventKit : MonoBehaviour,
        ...
        IMoveHandler, ISubmitHandler, ICancelHandler
    {
        ...
        public static EventKit Get(GameObject target)
        {
            if (target == null)
            {
            ...
            var eventKit = target.GetComponent<EventKit>();
            if (eventKit == null)
            {
                eventKit = target.AddComponent<EventKit>();
            }
        ...
        /// <returns>EventKit组件实例</returns>
        public static EventKit Get(Component target)
        {
        ...
        public EventKit SetOnPointerEnter(Action<PointerEventData> callback)
        {
        ...
        public EventKit SetOnPointerExit(Action<PointerEventData> callback)
        {
        ...
        public EventKit SetOnPointerDown(Action<PointerEventData> callback)
        {
        ...
        public EventKit SetOnPointerUp(Action<PointerEventData> callback)
        {
        ...
        public EventKit SetOnPointerClick(Action<PointerEventData> callback)
        {
        ...
        public EventKit SetOnInitializePotentialDrag(Action<PointerEventData> callback)
        {
        ...
        public EventKit SetOnBeginDrag(Action<PointerEventData> callback)
        {
        ...
        public EventKit SetOnDrag(Action<PointerEventData> callback)
        {
        ...
        public EventKit SetOnEndDrag(Action<PointerEventData> callback)
        {
        ...
        public EventKit SetOnDrop(Action<PointerEventData> callback)
        {
        ...
        public EventKit SetOnScroll(Action<PointerEventData> callback)
        {
        ...
        public EventKit SetOnUpdateSelected(Action<BaseEventData> callback)
        {
        ...
        public EventKit SetOnSelect(Action<BaseEventData> callback)
        {
        ...
        public EventKit SetOnDeselect(Action<BaseEventData> callback)
        {
        ...
        public EventKit SetOnMove(Action<AxisEventData> callback)
        {
        ...
        public EventKit SetOnSubmit(Action<BaseEventData> callback)
        {
        ...
        public EventKit SetOnCancel(Action<BaseEventData> callback)
        {
        ...
        public EventKit AddOnPointerEnter(Action<PointerEventData> callback)
        {
            OnPointerEnterEvent += callback;
            return this;
        }
        ...
        public EventKit AddOnPointerExit(Action<PointerEventData> callback)
        {
            OnPointerExitEvent += callback;
            return this;
        }
        ...
        public EventKit AddOnPointerDown(Action<PointerEventData> callback)
        {
            OnPointerDownEvent += callback;
            return this;
        }
        ...
        public EventKit AddOnPointerUp(Action<PointerEventData> callback)
        {
            OnPointerUpEvent += callback;
            return this;
        }
        ...
        public EventKit AddOnPointerClick(Action<PointerEventData> callback)
        {
            OnPointerClickEvent += callback;
            return this;
        }
        ...
        public EventKit AddOnDrag(Action<PointerEventData> callback)
        {
            OnDragEvent += callback;
            return this;
        }
        ...
        public EventKit AddOnScroll(Action<PointerEventData> callback)
        {
            OnScrollEvent += callback;
            return this;
        }
        ...
        public EventKit RemoveOnPointerEnter(Action<PointerEventData> callback)
        {
            OnPointerEnterEvent -= callback;
            return this;
        }
        ...
        public EventKit RemoveOnPointerExit(Action<PointerEventData> callback)
        {
            OnPointerExitEvent -= callback;
            return this;
        }
        ...
        public EventKit RemoveOnPointerClick(Action<PointerEventData> callback)
        {
            OnPointerClickEvent -= callback;
            return this;
        }
        ...
        public EventKit ClearAllEvents()
        {
