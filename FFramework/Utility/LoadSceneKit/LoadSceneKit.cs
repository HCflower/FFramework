...
namespace FFramework.Kit
{
    ...
    /// 场景加载工具类
    /// </summary>
    public class LoadSceneKit : SingletonMono<LoadSceneKit>
    {
        LoadSceneKit() => IsDontDestroyOnLoad = true;
        public float progress;                                      // 加载进度
        private bool canUnLoadAllScene = false;                     // 是否可以卸载所有场景
        private IScene currentScene;                             // 当前场景
        ...
        /// 设置和加载场景
        /// </summary>
        public void SetAndLoadScene(IScene scene)
        {
